                    ...
                    <tbody>
                        <c:forEach var="taskItem" items="${workloadData}">
                            <tr>
                                ...
                                <td><strong>TSK-${taskItem.task.taskId}</strong></td>
                        ...
                        <c:if test="${empty workloadData}">
                            <tr>
                                <td colspan="5" style="text-align: center; font-style: italic; color: #888; padding: 40px;">You have no active tasks at the moment. Enjoy your break!</td>
                            </tr>
                        </c:if>
                    </tbody>
                </table>
